...
| 76 | добавление счётчика в status/dashboard | считать за текущий запуск (из pipeline summary), не агрегировать по БД | пользователь видит что происходит сегодня, а не накопленный итог | universal | 1 | Universal |
