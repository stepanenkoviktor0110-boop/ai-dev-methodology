...
| 95 | добавление depends_on к задаче в той же волне что и зависимость | проверить wave(задача) > max(wave(все depends_on)), сдвинуть если равны | не создавать wave ordering violation обнаруживаемый только при feature-execution | universal | 1 | Universal |
