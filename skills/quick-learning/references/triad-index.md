...
| 82 | задача A создаёт файл, задача B в позднейшей волне его расширяет | ограничить scope A нуждами её волны; в бриф B явно написать "файл уже существует с X, добавить Y" | избежать дублирования реализации при параллельной генерации task-creator'ами | universal | 1 | Universal |
