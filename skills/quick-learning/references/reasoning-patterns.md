...
### 2026-06-09 hot-funnel / session 1: Якорь «сейчас» из инструмента vs авторитетный контекст

**Seen:** 1
**Adapted:** —
**Cognitive Error:** tool-clock anchor trust
**Triad:** считаешь пачку относительных значений («сегодня/завтра») от одного якоря, а два источника расходятся в самом якоре → согласуй якорь с авторитетным источником ДО фан-аута, верифицируй базу один раз, не производные → tool-clock anchor trust: молча взять «сейчас» из вывода инструмента, проигнорировав явно расходящийся авторитетный контекст
**Context:** Относительные дедлайны («завтра», «послезавтра») считались от «сегодня», взятого из вывода скрипта, хотя авторитетный контекст сессии давал другую дату. Расхождение было видно, но не сверено — сдвиг на день молча размножился в 9+ записей и потребовал массового +1 фикса.
