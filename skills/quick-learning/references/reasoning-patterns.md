...
**Seen:** 1
**Adapted:** —
**Triad:** создание нового скилла/артефакта в локальном репо → спросить "в публичный репо или личный?" до git add → не допустить попадания личных инструментов в публичный репо
**Context:** content-card и moneymaker-* были закоммичены в публичный репо методологии без согласования. Пользователь специально оговаривал это правило раньше, но оно не сработало в новой сессии.
**Pattern:** Перед любым `git add` нового скилла или персонального артефакта — явно спросить: "Этот скилл входит в публичный репо или остаётся личным?" Не предполагать публичность только потому что файл лежит в ~/.claude/skills/.
**Scope:** universal
**Category:** scope-management
